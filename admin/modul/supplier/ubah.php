...
<html>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="kontak_sup" aria-describedby="emailHelp" placeholder="Masukkan Email" value="<?php echo $r['kontak_sup']; ?>">
  ...
  <div class="form-group">
    ...
    <small id="emailHelp" class="form-text text-muted">Masukkan Nomor Telepon</small>
      ...
      <button type="button" class="btn btn-secondary" onclick="window.location.href='?m=supplier&s=awal'">Close</button>
