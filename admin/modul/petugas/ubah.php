  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <form action="?m=petugas&s=update&status=success" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" onclick="window.location.href='?m=petugas&s=awal'">Close</button>
