...
<html>
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" onclick="window.location.href='?m=admin&s=awal'">Close</button>
    <button type="submit" name="simpan" class="btn btn-primary" onclick="return confirm('Anda yakin ingin simpan data ini?');">Save changes</button>
  </div>
        </form>
